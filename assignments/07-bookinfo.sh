...
cd ../product
docker run -d -p 8083:9080 --name product --link reviews:reviews --link details:details --link ratings:ratings -e 'DETAILS_HOSTNAME=http://details:9080/details' -e 'RATINGS_HOSTNAME=http://ratings:8080/' -e 'REVIEWS_HOSTNAME=http://reviews:9080/' products
